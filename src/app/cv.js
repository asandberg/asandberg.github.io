    ...
    this.education = [
      {
        ...
        time: "2013 – ",
        desc: "Interactive media, game studies, Internet, social media, information science. Minor studies: information technology, programming, project management, user interface design, Japanese language.<br>One year of exchange studies in Daito Bunka University, Tokyo, Japan."
      },
      {
